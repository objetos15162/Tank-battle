...
{
    private int velocidadBala; //velocidad de la bala del enemigo
    private int tiempoGiro; //tiempo en que el tanque enemigo da giro
    private int velocidad; //velocidad  de avance del enemigo
    ...
    public void dispara()
    {
        ...
        {
            Actor Bala=new BalaEnemigo(getRotation()); //crea la bala del enemigo
            int x=getX();
            int y=getY();
